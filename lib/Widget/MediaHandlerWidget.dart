...
class MediaHandlerWidget {
  ...
  Future<void> handleVideoSend() async {
    ...
    try {
      ...
      String videoPath =
          pickedVideo.path; // Store path for local playback if needed
      ...
      String mimeType = lookupMimeType(videoName,
              headerBytes: videoBytes.take(1024).toList()) ??
          'video/mp4';
      ...
      print(
          "VideoFileMessage created: ${videoFileMessage.fileName}, size: ${videoFileMessage.readableSize}");
